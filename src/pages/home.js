    ...
    <div className="App">
        ...
        <div class="container-fluid d-flex align-items-center justify-content-between">
          ...
          <nav id="navbar" class="navbar">
            <ul>
              ...
              <li><a class="nav-link scrollto" href="/sign-in">Sign In</a></li>
            </ul>
            <i class="bi bi-list mobile-nav-toggle d-none"></i>
          </nav>

          <a class="btn-getstarted scrollto" href="/sign-up">Get Started</a>
      ...
      <section id="hero-animated" class="hero-animated d-flex align-items-center">
        <div class="container d-flex flex-column justify-content-center align-items-center text-center position-relative" data-aos="zoom-out">
          <img src="assets/img/fashion.png" class="img-fluid animated"></img>
          <h2>Welcome to <span>Fit Factory!</span></h2>
          <p>This web app will analyze what clothes you most and least frequently wear.</p>
          <div class="d-flex">
            <a href="/sign-up" class="btn-get-started scrollto">Get Started</a>
          </div>
        </div>
      </section>
            ...
            <div class="row gy-4">
              ...
              <div class="col-xl-3 col-md-6 d-flex" data-aos="zoom-out">
                <div class="service-item position-relative">
                  ...
                  <h4><a href="" class="stretched-link">Analytics</a></h4>
              ...
              <div class="col-xl-3 col-md-6 d-flex" data-aos="zoom-out" data-aos-delay="200">
                <div class="service-item position-relative">
                  ...
                  <h4><a href="" class="stretched-link">Easy to Start</a></h4>
              ...
              <div class="col-xl-3 col-md-6 d-flex" data-aos="zoom-out" data-aos-delay="400">
                <div class="service-item position-relative">
                  ...
                  <h4><a href="" class="stretched-link">Quick Process</a></h4>
              ...
              <div class="col-xl-3 col-md-6 d-flex" data-aos="zoom-out" data-aos-delay="600">
                <div class="service-item position-relative">
                  ...
                  <h4><a href="" class="stretched-link">Privacy</a></h4>
        ...
        <section id="about" class="about">
          <div class="container" data-aos="fade-up">
            ...
            <div class="row g-4 g-lg-5" data-aos="fade-up" data-aos-delay="200">
              ...
              <div class="col-lg-7">
                <h3 class="pt-0 pt-lg-5">Using coding to save the world, one problem at a time</h3>

                <ul class="nav nav-pills mb-3">
                  <li><a class="nav-link active" data-bs-toggle="pill" href="#tab1">Inspiration</a></li>
                  <li><a class="nav-link" data-bs-toggle="pill" href="#tab3">Projects</a></li>
                </ul>
                ...
                <div class="tab-content">
                  ...
                  <div class="tab-pane fade show active" id="tab1">
                    ...
                    <p class="fst-italic">My inspiration for this project stemmed from myself. I'm not sure which clothes I don't wear so when I inevitably go through my closet to donate and clear out the clutter, I'm not sure where to start.</p>
                  ...
                  <div class="tab-pane fade show" id="tab3">
                    ...
                    <p class="fst-italic">I love programming with a passion, especially making websites. Here are some of my most recent projects!</p>

                    <div class="d-flex align-items-center mt-4">
                      <i class="bi bi-check2"></i>
                      <a href="https://github.com/ciscops/iot-application-server" target="_blank" class="project-link"><h4>IoT Application Server</h4></a>
                    </div>
                    ...
                    <div class="d-flex align-items-center mt-4">
                      <i class="bi bi-check2"></i>
                      <a href="https://devpost.com/software/project-yb2vuhx5sqkl" target="_blank" class="project-link"><h4>Taxi Traffic</h4></a>
                    </div>
                    ...
                    <div class="d-flex align-items-center mt-4">
                      <i class="bi bi-check2"></i>
                      <a href="https://devpost.com/software/project-yb2vuhx5sqkl" target="_blank" class="project-link"><h4>OTIS</h4></a>
                    </div>
        ...
        <div class="footer-legal text-center">
          <div class="container d-flex flex-column flex-lg-row justify-content-center justify-content-lg-between align-items-center">
            ...
            <div class="social-links order-first order-lg-last mb-3 mb-lg-0">
              <a href="https://briannata.github.io/" target="_blank"><i class="bi bi-laptop"></i></a>
              <a href="https://www.linkedin.com/in/briannata/" target="_blank"><i class="bi bi-linkedin"></i></a>
              <a href="https://github.com/briannata" target="_blank"><i class="bi bi-github"></i></a>
              <a href="mailto:brianna.hy.ta@gmail.com" target="_blank"><i class="bi bi-envelope"></i></a>
